...
func TestPassage_NewPassageOnX(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			doorOne: primitives.Point2D[int]{X: 2, Y: 1},
			doorTwo: primitives.Point2D[int]{X: 6, Y: 4},
			wantErr: false,
		},
		{
			name:    "DoorOne is further than doorTwo",
			doorOne: primitives.Point2D[int]{X: 6, Y: 4},
			doorTwo: primitives.Point2D[int]{X: 2, Y: 1},
			wantErr: false,
		},
		{
			name:    "Passage on one axis Y",
			doorOne: primitives.Point2D[int]{X: 1, Y: 6},
			doorTwo: primitives.Point2D[int]{X: 5, Y: 6},
			wantErr: false,
		},
		{
			name:      "Err: Passage on one axis X",
			doorOne:   primitives.Point2D[int]{X: 6, Y: 1},
			doorTwo:   primitives.Point2D[int]{X: 6, Y: 5},
			wantErr:   true,
