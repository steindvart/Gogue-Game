...
func TestGetScrollConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: 1, Max: 3},
		...
		},
		{
			...
			wantAgilityRange:   primitives.AttributeRange{Min: 1, Max: 3},
			wantMaxHealthRange: primitives.AttributeRange{Min: 0, Max: 0},
		},
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: 0, Max: 0},
			wantAgilityRange:   primitives.AttributeRange{Min: 0, Max: 0},
			wantMaxHealthRange: primitives.AttributeRange{Min: 2, Max: 10},
		},
		{
			...
			wantMaxHealthRange: primitives.AttributeRange{Min: -3, Max: 8},
		},
		{
