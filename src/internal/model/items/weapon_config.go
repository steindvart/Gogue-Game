...
var WeaponRegistry = map[WeaponType]WeaponConfig{
	...
	WeaponTypeAxe: {
		Type:          WeaponTypeAxe,
		StrengthRange: primitives.AttributeRange{Min: 7, Max: 15},
		AgilityRange:  primitives.AttributeRange{Min: -8, Max: -3},
		Description:   "A heavy weapon with high damage but reduced agility",
	},
	WeaponTypeMaul: {
		Type:          WeaponTypeMaul,
		StrengthRange: primitives.AttributeRange{Min: 8, Max: 18},
		AgilityRange:  primitives.AttributeRange{Min: -12, Max: -5},
		Description:   "The heaviest weapon with devastating damage but significant agility penalty",
	},
	WeaponTypeMystery: {
		Type:          WeaponTypeMystery,
		StrengthRange: primitives.AttributeRange{Min: -2, Max: 20},
...
func (cfg WeaponConfig) GenerateAttributes(rnd utils.Randomizer) primitives.Attributes {
