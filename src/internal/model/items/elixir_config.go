...
var ElixirRegistry = map[ElixirType]ElixirConfig{
	...
	ElixirTypeDwarfism: {
		...
		StrengthRange:      primitives.AttributeRange{Min: -8, Max: -2},
		AgilityRange:       primitives.AttributeRange{Min: 8, Max: 20},
		DurationStepsRange: defaultDurationRange,
		Description:        "Greatly increases agility but weakens strength",
	},
	ElixirTypeGiantism: {
		Type:               ElixirTypeGiantism,
		StrengthRange:      primitives.AttributeRange{Min: 8, Max: 20},
		AgilityRange:       primitives.AttributeRange{Min: -8, Max: -2},
		DurationStepsRange: defaultDurationRange,
	...
	ElixirMaxHealth: {
		...
		StrengthRange:      primitives.AttributeRange{Min: 0, Max: 0},
		AgilityRange:       primitives.AttributeRange{Min: 0, Max: 0},
		MaxHealthRange:     primitives.AttributeRange{Min: 15, Max: 35},
		DurationStepsRange: defaultDurationRange,
	...
	ElixirTypeMystery: {
		...
		AgilityRange:       primitives.AttributeRange{Min: -15, Max: 20},
		MaxHealthRange:     primitives.AttributeRange{Min: -20, Max: 40},
		DurationStepsRange: defaultDurationRange,
