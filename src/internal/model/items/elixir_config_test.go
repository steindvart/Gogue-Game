...
func TestGetElixirConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: 3, Max: 12},
		...
		},
		{
			...
			wantAgilityRange:   primitives.AttributeRange{Min: 3, Max: 12},
			wantMaxHealthRange: primitives.AttributeRange{Min: 0, Max: 0},
			wantDurationRange:  defaultDurationRange,
		},
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: -8, Max: -2},
			wantAgilityRange:   primitives.AttributeRange{Min: 8, Max: 20},
			wantMaxHealthRange: primitives.AttributeRange{Min: 0, Max: 0},
			wantDurationRange:  defaultDurationRange,
		},
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: 8, Max: 20},
			wantAgilityRange:   primitives.AttributeRange{Min: -8, Max: -2},
			wantMaxHealthRange: primitives.AttributeRange{Min: 0, Max: 0},
			wantDurationRange:  defaultDurationRange,
		},
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: 0, Max: 0},
			wantAgilityRange:   primitives.AttributeRange{Min: 0, Max: 0},
			wantMaxHealthRange: primitives.AttributeRange{Min: 15, Max: 35},
			wantDurationRange:  defaultDurationRange,
		},
		{
			...
			wantAgilityRange:  primitives.AttributeRange{Min: -15, Max: 20},
			wantDurationRange: defaultDurationRange,
		},
		{
			...
			wantStrengthRange:  primitives.AttributeRange{Min: -15, Max: 20},
			wantAgilityRange:   primitives.AttributeRange{Min: -15, Max: 20},
			wantMaxHealthRange: primitives.AttributeRange{Min: -20, Max: 40},
			wantDurationRange:  defaultDurationRange,
		},
	}
