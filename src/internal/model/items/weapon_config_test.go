...
func TestGetWeaponConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantAgilityRange:  primitives.AttributeRange{Min: 5, Max: 12},
		},
		{
			name:              "Get Spear config",
			weaponType:        WeaponTypeSpear,
			wantType:          WeaponTypeSpear,
			wantStrengthRange: primitives.AttributeRange{Min: 7, Max: 18},
			wantAgilityRange:  primitives.AttributeRange{Min: 2, Max: 8},
		},
		{
			name:              "Get Sword config",
			weaponType:        WeaponTypeSword,
			wantType:          WeaponTypeSword,
			wantStrengthRange: primitives.AttributeRange{Min: 15, Max: 20},
			wantAgilityRange:  primitives.AttributeRange{Min: -2, Max: 5},
		},
		{
			name:              "Get Axe config",
			weaponType:        WeaponTypeAxe,
			wantType:          WeaponTypeAxe,
			wantStrengthRange: primitives.AttributeRange{Min: 17, Max: 35},
			wantAgilityRange:  primitives.AttributeRange{Min: -9, Max: -4},
		},
		{
			name:              "Get Maul config",
			weaponType:        WeaponTypeMaul,
			wantType:          WeaponTypeMaul,
			wantStrengthRange: primitives.AttributeRange{Min: 20, Max: 45},
			wantAgilityRange:  primitives.AttributeRange{Min: -15, Max: -5},
		},
		{
			name:              "Get Mystery config",
			weaponType:        WeaponTypeMystery,
			wantType:          WeaponTypeMystery,
			wantStrengthRange: primitives.AttributeRange{Min: 1, Max: 50},
			wantAgilityRange:  primitives.AttributeRange{Min: -20, Max: 20},
		},
		{
