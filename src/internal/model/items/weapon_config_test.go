...
func TestGetWeaponConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 3, Max: 8},
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 5, Max: 10},
			wantAgilityRange:  primitives.AttributeRange{Min: -3, Max: 3},
		},
		{
			name:              "Get Axe config",
			weaponType:        WeaponTypeAxe,
			wantType:          WeaponTypeAxe,
			wantStrengthRange: primitives.AttributeRange{Min: 7, Max: 15},
			wantAgilityRange:  primitives.AttributeRange{Min: -8, Max: -3},
		},
		{
			name:              "Get Maul config",
			weaponType:        WeaponTypeMaul,
			wantType:          WeaponTypeMaul,
			wantStrengthRange: primitives.AttributeRange{Min: 8, Max: 18},
			wantAgilityRange:  primitives.AttributeRange{Min: -12, Max: -5},
		},
		{
			name:              "Get Mystery config",
			weaponType:        WeaponTypeMystery,
			wantType:          WeaponTypeMystery,
			wantStrengthRange: primitives.AttributeRange{Min: -2, Max: 20},
