...
func TestGetWeaponConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 2, Max: 7},
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 5, Max: 14},
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 10, Max: 16},
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 12, Max: 25},
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 15, Max: 30},
		...
		},
		{
			...
			wantStrengthRange: primitives.AttributeRange{Min: 1, Max: 35},
