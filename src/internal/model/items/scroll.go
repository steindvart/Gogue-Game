...
func NewScrollBuiltin(rnd *utils.Random, box primitives.Box, t ScrollType) *Scroll {
	s, _ := NewScrollByConfig(rnd, box, GetScrollConfig(t))
	return s
}

func NewScrollByConfig(rnd *utils.Random, box primitives.Box, cfg ScrollConfig) (*Scroll, error) {
